            ...
            <AlertDialog>
              <DropdownMenu>
                <Card className="my-4 dark:bg-slate-900 bg-white shadow-none transition-all">
                  ...
                  <CardFooter className="m-0 p-2 border-t-[1px] border-muted-foreground flex items-center justify-between">
                ...
                <AlertDialogContent>
                  ...
                  <AlertDialogFooter className="flex items-center">
                    ...
                    <AlertDialogAction
                      className="bg-destructive hover:bg-red-900/80"
