...
const MediaCard = ({ file }: Props) => {
  ...
  return (
    <AlertDialog>
      <DropdownMenu>
        <article className="border w-full rounded-lg bg-blue-100 dark:bg-slate-900">
          ...
          <div className="p-4 relative">
            ...
            <p className="text-black/90 dark:text-white">{file.name}</p>
            <div className="absolute top-4 right-4 p-[1px] cursor-pointer text-black/80 dark:text-white">
              <DropdownMenuTrigger>
                <MoreHorizontal />
              </DropdownMenuTrigger>
            </div>
