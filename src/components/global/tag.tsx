  ...
  return (
    <div
      className={clsx("p-2 rounded-sm flex-shrink-0 text-xs cursor-pointer", {
        ...
        "border-[1px] border-[#57acea] hover:bg-[#57acea]":
          colorName === "BLUE" && !title,
        "border-[1px] border-[#ffac7e] hover:bg-[#ffac7e]":
          colorName === "ORANGE" && !title,
        "border-[1px] border-rose-500 hover:bg-rose-500":
          colorName === "ROSE" && !title,
        "border-[1px] border-emerald-400 hover:bg-emerald-400":
          colorName === "GREEN" && !title,
        "border-[1px] border-purple-400 hover:bg-purple-400":
