      ...
      <Command className="bg-transparent">
        ...
        <div className="relative mt-2">
          ...
          <PlusCircleIcon
            ...
            size={20}
            className="absolute top-1/2 transform -translate-y-4 right-3 hover:text-primary transition-all cursor-pointer text-muted-foreground"
          />
        </div>
        <CommandList>
          <CommandSeparator />
          {!!tags?.length && (
            <CommandGroup heading="Tags" className="relative">
              {tags.map((tag) => (
                <CommandItem
                  key={tag.id}
                ...
                >
                  ...
                  <AlertDialogContent className="z-[300] rounded-md">
                    <AlertDialogHeader>
          ...
          {value.length > 0 && !tags.length && (
            <div className="text-muted-foreground flex items-center justify-center mt-2 mb-2">
              No results found.
            </div>
          )}
        </CommandList>
